...
public class NofiticationConstants{
    ...
    public static final NotificationMessage L2 = new NotificationMessage("Congratulations \uD83C\uDF8A \uD83C\uDF8A","You've leveled up!", 2, R.drawable.fireworks);
    public static final NotificationMessage L3 = new NotificationMessage("Hooray \uD83C\uDF89 \uD83C\uDF89", "That's a new level!", 2, R.drawable.fireworks);
    public static final NotificationMessage L4 = new NotificationMessage("Woo Hoo \uD83D\uDC4F \uD83D\uDC4F \uD83D\uDC4F", "You made it, another level!", 2, R.drawable.fireworks);
    public static final NotificationMessage L5 = new NotificationMessage("❤Amazing❤", "You've reached a higher level!", 2, R.drawable.fireworks);
